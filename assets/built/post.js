...
(0,medium_zoom__WEBPACK_IMPORTED_MODULE_1__.default)(totalImages, {
...
var footer = document.querySelector('.outer-container--footer');
...
function tablePrepend(e) {
  ...
  responsiveWrapper.setAttribute('style', 'width: 100%; overflow-x: auto; margin: 1em 0; border-radius: 4px; border: 1px solid var(--text4)');
