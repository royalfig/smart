...
var tabKeyHandler = function tabKeyHandler(tabs, e) {
...
var trapFocus = function trapFocus(sideMenuEl) {
  ...
  sideMenuEl.addEventListener('keydown', tabKeyHandler.bind(null, [firstTabStop, lastTabStop]));
};
...
/* harmony import */ var _toast__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_toast__WEBPACK_IMPORTED_MODULE_3__);
...
var testWindowLocation = function testWindowLocation(testCase1, testCase2) {
  var regEx1 = new RegExp(testCase1);
  var regEx2 = new RegExp(testCase2);
  var testFirstCase = regEx1.test(window.location.search);
  var testSecondCase = regEx2.test(window.location.search);
